...
const LoginForm = ({ onSwitchForm }) => {
  ...
  return (
    <div className="w-full max-w-md mx-auto bg-white shadow-lg rounded-2xl p-8 space-y-6">
      <h2 className="text-3xl font-bold text-center text-gray-800">Welcome Back</h2>
      <p className="text-sm text-center text-gray-500">Please enter your credentials to sign in</p>
      ...
      <div className="grid">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 48 48">
            ...
            <path fill="#1565c0" d="M43.611,20.083L43.595,20L42,20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.571	l6.19,5.238C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z" />
          </svg>
          Google
        </button>
